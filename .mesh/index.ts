...
export type HelloWorldQuery = Pick<Query, 'greeting'>;
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    HelloWorld(variables?: HelloWorldQueryVariables, options?: C): Promise<HelloWorldQuery> {
      return requester<HelloWorldQuery, HelloWorldQueryVariables>(HelloWorldDocument, variables, options) as Promise<HelloWorldQuery>;
    }
  };
}

...
import type { HelloWorldTypes } from './sources/Hello World/types';
import * as importedModule$0 from "./sources/Hello World/schemaWithAnnotations";
...
export type MeshContext = HelloWorldTypes.Context & BaseMeshContext;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  ...
  switch(relativeModuleId) {
    case ".mesh/sources/Hello World/schemaWithAnnotations":
...
const helloWorldHandler = new OpenapiHandler({
              name: "Hello World",
              config: {"endpoint":"http://localhost:8080","source":"./oas.yml"},
              baseDir,
              cache,
              pubsub,
              store: sourcesStore.child("Hello World"),
...
transforms[0] = new (FederationTransform as any)({
            apiName: '',
            config: {"version":"v1.0"},
            baseDir,
            cache,
